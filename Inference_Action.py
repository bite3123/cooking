...
def inference_action_test2(device, hidden_dim, num_action, node_feature_size, edge_feature_size, global_dim, batch_size, lr, num_epoch, data_dir, show_result, infer_num=None, check_each = False):
    ...
    for test_data in data_test_loader:
        ...
        L_action = loss_ce_action(pred_action_prob, test_act_label)
        L_object = loss_bce_object(pred_object_prob, test_obj_label)
        L_total = L_action + L_object
