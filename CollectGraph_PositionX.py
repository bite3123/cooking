...
class CollectGraph():
    ...
    def collect_graph(self, data_type, auto_save=False, dataset_name=None, OnlyFinalGoal=False):
        ...
        #추가예정
        #collect_graph.extend(self.collect_mixingv2(data_type))
        #collect_graph.extend(self.collect_mixingv3(data_type))
        #collect_graph.extend(self.collect_mixingv4(data_type))
    ...
    def collect_mixingv2(self, data_type):
        mixing5_graph = []
        mixing_5 = ReadDataset(task='mixing_v2', sort_edge=False)
...
action_data = stack_mix_5_data.collect_graph(data_type='action', dataset_name='stacking5_mixing5_PoseX',auto_save=True, OnlyFinalGoal=True)
