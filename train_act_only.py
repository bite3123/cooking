...
total_dataset = StackingDataset('stacking_dataset_nopos')
...
for epoch in range(200):
    ...
    for i, data in enumerate(train_loader):
        ...
        pred_action_prob= model(input, target)
    ...
    for i, data in enumerate(test_loader):
        ...
        test_pred_action_prob = model(test_input, test_target)
    ...
    if test_avg_loss < best_loss:
        ...
        model_path = './stacking_model_nopos_act_adam_BCE/stacking_model_{}.pth'.format(epoch)
        torch.save(model.state_dict(), model_path)

#save loss record
file_path = "./stacking_model_nopos_act_adam_BCE/loss_data"
